...
Queda pendiente, como Fase 12b, aplicar el mismo patrón a `#editModal` ("Configurar Tablero"): hoy mezcla el formulario de añadir palabra, el respaldo/OBF y la lista completa del catálogo en un solo scroll.
